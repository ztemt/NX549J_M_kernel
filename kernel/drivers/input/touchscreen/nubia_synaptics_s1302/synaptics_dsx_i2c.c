...
static int parse_dt(struct device *dev, struct synaptics_dsx_board_data *bdata)
{
	...
	pr_err("[TP]%s: synaptics1302 irq-on-state = %d\n", __func__, bdata->irq_on_state);
	...
	{
		bdata->power_gpio = -1;
		pr_err("[TP]%s: can't get synaptics1302 power-gpio !\n", __func__);
	}
	...
	pr_err("[TP]%s: synaptics1302 reset-on-state = %d\n", __func__, bdata->reset_on_state);
	...
	pr_err("[TP]%s: synaptics1302 reset-active-ms = %d\n", __func__, bdata->reset_active_ms);
	...
	pr_err("[TP]%s: synaptics1302 reset_delay_ms = %d\n", __func__, bdata->reset_delay_ms);
	...
	pr_err("[TP]%s: synaptics1302 lcd-reset-gpio = %d\n", __func__, bdata->lcd_reset_gpio);
