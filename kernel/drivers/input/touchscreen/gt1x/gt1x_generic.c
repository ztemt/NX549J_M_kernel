...
/*******************GLOBAL VARIABLE*********************/
static struct wake_lock gt1x_gesture_wakelock;
...
{
    int count = 0;
    wake_lock_timeout(&gt1x_gesture_wakelock,msecs_to_jiffies(500));
...
s32 gt1x_init(void)
{
    ...
    wake_lock_init(&gt1x_gesture_wakelock, WAKE_LOCK_SUSPEND ,"gt1x_gesture_wakelock");
...
void gt1x_deinit(void)
{
    ...
    wake_lock_destroy(&gt1x_gesture_wakelock);
#if GTP_GESTURE_WAKEUP || GTP_HOTKNOT
    gt1x_deinit_node();
#endif
